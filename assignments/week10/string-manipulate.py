...
string = "The Quick Brwon Fox Jumps Over The Laz"

print("=== TEXT ANALYSIS REPORT ===")
print("Character Analysis:")
print("- Total character: %d (with spaces), %d (without spaces)" % (len(string), len(string) - string.count(" ")))
...
print("- Vowel: %d (%s)" % (vowels, vowelsStr))
